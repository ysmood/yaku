...
If you want to learn how Promise works, read the minimum implementation [src/yaku.aplus.js][]. Without comments, it is only 80 lines of code (gzipped size is 0.5KB).
